...
# Priority 1: Launch native .app if it exists
...
# Try Chrome/Chromium kiosk mode, fall back to Safari
if open -a "Google Chrome" --args --kiosk --no-first-run \
    ...
    echo "ℹ️  Safari mode (compile native app: bash YankunFrameNative/compile.sh)"
fi
